    ...
    displayTaskInfo = ()=>{
        return(
            <div>
                ...
                <hr />
                <button onClick={()=>{this.toggleEditTaskForm()}}>
                    {this.showingEditForm ? "Cancel" : "Edit task"}
                </button>
                {this.showingEditForm && <EditTask taskInfo={this.state.taskInfo} getTaskInfo={this.getTaskInfo} {...this.props} />}
                <hr />
